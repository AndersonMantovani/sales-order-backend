...
// SalesOrderHeaders
module.exports.SalesOrderHeader = createEntityProxy(['sales', 'SalesOrderHeaders'], { target: { is_singular: true } })
module.exports.SalesOrderHeaders = createEntityProxy(['sales', 'SalesOrderHeaders'], { target: { is_singular: false }})
// SalesOrderItems
